extends Node2D
#Script for the fourth and final level. Not much more differences than the last level.
var timer = 1000
@onready var player = get_tree().get_first_node_in_group("Player")
@onready var screen = $Level_elements/Player/Camera2D/CanvasLayer/Fade
...
func _ready() -> void:
	...
	key.game_complete.connect(lights_out)
